...
{
    [TestClass]
    public class QueenManeuverTest
    {
        ...
        public void Should_Count_Phone_Numbers_From_Position()
        {
            ...
            var maneuver = new QueenManeuver(_keypad, _phoneNumberLength, _startValidationRules, _maneuverValidationRules);

            // Act
            int count = maneuver.CalculateTotalValidNumbers();

            // Assert
            Assert.AreEqual(751503, count);
        }
...
#pragma warning disable CS8604 // Possible null reference argument.
            var maneuver = new QueenManeuver(_keypad, _phoneNumberLength);
