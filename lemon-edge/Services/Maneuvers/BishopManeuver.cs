...
public class BishopManeuver(IKeypad keypad, int phoneNumberLength, IEnumerable<IStartValidationRule>? startValidationRules = null, IEnumerable<IManeuverValidationRule>? maneuverValidationRules = null)
: BaseManeuver(keypad, maneuver, phoneNumberLength, startValidationRules, maneuverValidationRules)
{

    private static readonly Maneuver maneuver = new(ManeuverType.Bishop, new List<Move> {
        new(1, 1),
        new(1, -1),
        new(-1, 1),
        new(-1, -1)
